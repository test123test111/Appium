...
//		System.out.println(getLocator("loginOrReg", file("鹿管家")));
//		getLocator("loginOrReg", file("鹿管家"));
	}
	 ...
	 * @return
	 */
	public static String file(String projectname){
		if(projectname.equals("鹿管家")){
			return "configs/element.properties";
		}else {
			return "configs/element.properties";
		}
	}
