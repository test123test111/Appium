...
//        int s = random.nextInt(max)%(max-min+1) + min;
	...
	public static int getInt(String str,int index){
        ...
        if(!result.isEmpty()&&index<result.size()){
        	...
        	System.out.println("你要找的第"+(index+1)+"个数字不存在");
        	return -1;
        }
	}
	public static void main(String[] args) {
//		Random r=new Random();
//		System.out.println(randomInt(3,10));
//		System.out.println(getRndStrZhByLen(5)+getRndStrByLen(5));
//		System.out.println(RandomUtil.getRndStrZhByLen(10));
