...
//			SendMail sm=new SendMail();
			SendMail.send("driver失败", e.getMessage());
		}
	}
	@DataProvider
	public Object[][] loginData() throws Exception{
		Object[][] ob=ExcelUtil.getTestData("C:\\Users\\Administrator\\Desktop\\CrazyAppium\\configs\\test.xlsx", "Sheet1");
		return ob;
	}
	...
	public void t001_login(String caseNumber,String caseName,String username,String password,String assertValue,String filename) throws Exception{
		ExcelUtil eu=new ExcelUtil("C:\\Users\\Administrator\\Desktop\\CrazyAppium\\configs\\test.xlsx", "Sheet1");
