...
public class CrazyCapabilities {
	public  DesiredCapabilities initCaps(String capsPath,String udid){
		...
		try {
			...
			caps.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, p.getPro(AndroidMobileCapabilityType.APP_PACKAGE));
			caps.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, p.getPro(AndroidMobileCapabilityType.APP_ACTIVITY));
	...
	public  DesiredCapabilities initCapsWait(String capsPath,String udid){
		...
		try {
			...
			caps.setCapability(AndroidMobileCapabilityType.APP_WAIT_ACTIVITY, p.getPro(AndroidMobileCapabilityType.APP_WAIT_ACTIVITY));
